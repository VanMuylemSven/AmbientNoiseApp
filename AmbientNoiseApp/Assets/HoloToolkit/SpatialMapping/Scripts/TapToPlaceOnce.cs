...
namespace HoloToolkit.Unity.SpatialMapping
{
    ...
    public class TapToPlaceOnce : MonoBehaviour, IInputClickHandler
    {
        ...
        //declare default bool on false to keep track of placement on menu
        ...
        public virtual void OnInputClicked(InputClickedEventData eventData)
        {
            ...
            //only execute if the object hasn't been placed yet
        ...
        private void StopPlacing()
        {
            ...
            //set HasBeenPlaced to true so it prevents further moving
            HasBeenPlaced = true;
        }
